...
class ItemModel(models.Model):
    ...
    launch_date = models.CharField(max_length=10, blank=True, null=True)
...
class LoanHistoryModel(models.Model):
    ...
    loan_date = models.ForeignKey(LoanerModel, related_name="loan_date", on_delete=models.CASCADE)
    return_date = models.ForeignKey(LoanerModel, related_name="return_date", on_delete=models.CASCADE)
